...
public final class GamePanel extends JPanel {
    ...
    public GamePanel() {
        ...
        backgroundPanel = new ImagePanel("img/main.png", 0, 0, 800, 600);

        // panel chứa bàn cờ 
        tablePanel = new ImagePanel("img/table.png", 20, 20, 480, 480);
        ...
        for (int i = 0; i < 16; i++) {
            for (int j = 0; j < 16; j++) {
                ...
                mySquare[i][j] = new ImagePanel("img/khung.png", i * 30, j * 30, 30, 30);
        ...
        myAction = new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                if (Main.startGame == true) {
                    ...
                    // lấy địa chỉ ô ấn vào từ 0 đến (max -1) theo cột dọc
                    ...
                    if (myStatus.statusBoard[row][col] == 0) {
                        if (player == 1) {
                            ...
                            if (numberPlayer == 1) { //chế độ mội người chơi 
                                ...
                                ImagePanel b = new ImagePanel("img/khung2.png", col * 30, row * 30, 30, 30);
                                tablePanel.add(b);
                                repaint();
