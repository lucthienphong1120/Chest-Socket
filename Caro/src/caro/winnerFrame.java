...
public class winnerFrame extends JFrame {
    ...
    public winnerFrame(int winner) {
        ...
        switch (winner) {
            case 0:
                // hòa nhau
                winnerPicture = new ImagePanel("img/draw.png", 0, 0, 400, 200);
                break;
            case 3:
                // người chơi thứ 1 thua máy tính
                winnerPicture = new ImagePanel("img/loser1.gif", 0, 0, 400, 200);
                break;
            default:
                winnerPicture = new ImagePanel("img/winner" + winner + ".gif", 0, 0, 400, 200);
                break;
        }
